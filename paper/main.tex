...
Our reproduction attains \num{52.68} CIDEr against the published 52.7, supporting its fidelity.
...
\item A documented reproduction of CoCap on VATEX, reaching \num{52.68} CIDEr against the
      published 52.7, together with the source-level fixes the original release requires on a
...
\textbf{Training duration.} \TODO{state whether validation CIDEr had plateaued by epoch 11; if
it was still rising, say the models are likely under-trained}
